export default function ProjectileInfoPanel({ velocity = {x:0,y:0,z:0}, position = {x:0,y:0,z:0}, mass = 1 }) {
    ...
    <div style={{
      ...
      <div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 6 }}>
          <span><strong>Total Energy:</strong></span>
          <span><strong>{total.toFixed(2)} J</strong></span>
        </div>
      </div>
      <div style={{
      width: 220,
